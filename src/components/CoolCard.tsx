...
export default function CoolCard() {
  ...
  return (
    <div
      className="relative h-[400vh] w-full overflow-clip rounded-md pt-40 dark:border dark:border-white/[0.1]"
      ref={ref}
    >
      <GoogleGeminiEffect
        title="Using the true power of Rust for Voxel manipulation"
        pathLengths={[
          pathLengthFirst,
          pathLengthSecond,
          pathLengthThird,
