...
export default function RevealPasswordButton({
  ...
  return (
    <button
      ...
      className={twMerge(
        "absolute right-3 top-[calc(50%-10px)] flex h-fit items-center text-sm text-black outline-none dark:text-white",
        className
      )}
    >
      {showPassword ? (
        <svg
          ...
          aria-hidden="true"
          role="img"
          className="text-default-400 iconify iconify--solar pointer-events-none text-2xl"
          width="1em"
          height="1em"
          viewBox="0 0 24 24"
        >
        ...
        <svg
          ...
          aria-hidden="true"
          role="img"
          className="pointer-events-none pt-1 text-2xl"
          width="1em"
          height="1em"
          viewBox="0 0 24 24"
        >
