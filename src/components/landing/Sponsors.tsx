...
export default function Sponsors() {
  function PlaceHolder() {
    return (
      <Link
        href="/contact"
        className="group flex size-full min-h-28 items-center justify-center gap-2 rounded-md border-2 border-dashed border-primary bg-primary p-2"
      >
        <div className="flex items-center gap-2 transition-transform duration-500 group-hover:scale-110">
          ...
          <h1 className="font-BrutalRegular text-secondary">Support</h1>
        </div>
      </Link>
    )
  }
  ...
  return (
    <>
      <h1 className="mb-6 text-4xl">Supporters</h1>
      <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
        <a
          href="https://international.epitech.eu/"
          target="_blank"
          className="flex size-full items-center justify-center rounded-md p-4 transition-colors hover:bg-primary"
        >
          <svg
            version="1.2"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 1575 392"
            className="w-full"
            fill="#0091d3"
          >
            <path
